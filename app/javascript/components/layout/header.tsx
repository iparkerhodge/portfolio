...
const Header: React.FC = () => (
    <div className='mx-4 sm:mx-40 py-5 border-b-[1px] grid grid-cols-4 grid-rows-1 items-center'>
        ...
        <ul className='col-span-2 justify-self-center flex justify-center'>
            <li className='px-2 text-xs sm:text-lg cursor-pointer hover:underline'><a href='/'>Home</a></li>
            <li className='px-2 text-xs sm:text-lg cursor-pointer hover:underline'><a href='/about'>About</a></li>
            <li className='px-2 text-xs sm:text-lg cursor-pointer hover:underline'><a href='/resume'>Resume</a></li>
            <li className='px-2 text-xs sm:text-lg cursor-pointer hover:underline'><a href='/projects'>Projects</a></li>
        </ul>
